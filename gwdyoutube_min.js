        ...
        prototype: Object.create(HTMLElement.prototype, {
            ...
            getOverlay_: {
                value: function(a) {
                    if (!this.b) {
                        ...
                        this.b.style.opacity = !!this.getAttribute('overlay-hide') ? 0 : 1;
                        ...
                        if (a) {
                            ...
                            this.b.style.backgroundColor = "rgba(255, 255, 255, .3)";
                            this.b.style.backgroundPosition = "center center";
                            this.b.style.backgroundRepeat = "no-repeat";
            ...
            thumbnailClickHandler_: {
                value: function(e) {
                    ...
                    window[this.getAttribute('thumbnailClick')]['playingHandler']();
                    this.removeAttribute('thumbnailClick');
                },
                enumerable: !1
            },
            attachedCallback: {
            ...
            getYouTubeOptions_: {
                value: function() {
                    ...
                    if (c = this.getAttribute("color")) b.color = c;
            ...
            onPlayerReady_: {
                value: function() {
                    ...
                    // window[this.getAttribute('id')]['ready']();
                },
                enumerable: !1
            },
            onStateChange_: {
